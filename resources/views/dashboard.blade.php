            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        Bakıp bakıp üzülecek bir tablo ama siz üzülmeyin. Zaten üzülmüyorsanız bi kahvenizi içerim.
                    </div>
                </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-500">
                                <table class="table-auto w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{ number_format($summary['USD']['price'], 2) }}</td>
                                            <td>{{ number_format($summary['EUR']['price'], 2) }}</td>
                                            <td>{{ number_format($summary['GBP']['price'], 2) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
